...
def login_with_cookie(driver):
    ...
    driver.add_cookie({'domain': '.tiktok.com', 'name': 'msToken', 'value': '0_VT8RLDNXHhX3hvnc5gBgbmVzpGNa2QNXd_CdlT3dl6UhNP4A-PTeVvncP-72ksAYXaxSEYOfVRRJXEv_xQ0cKxl6ZYVd_ZAGh4vAzK2v0KDFKINdik57fpcqckseX2MK-fB1hzUCcyHvONFV-IDY2wEQ=='})
