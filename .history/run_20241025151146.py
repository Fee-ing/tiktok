    ...
    driver.add_cookie(
        {
            "domain": ".tiktok.com",
            "name": "bm_sv",
            "value": "25DFC64DEB38C091FC7F1040E628AB3D~~1",
        }
    )
    driver.add_cookie(
        {
            "domain": ".tiktok.com",
            "name": "cmpl_token",
            "value": "AgQQAPNSF-RO0rb52574u50S_Xtq4_mSP5w3YNRyKA",
        }
    )
    driver.add_cookie(
        {
            "domain": ".tiktok.com",
            "name": "d_ticket",
            "value": "5c79f6a6c7430654565bb551f49309bb7fc8c",
        }
    )
    driver.add_cookie(
        {"domain": ".www.tiktok.com", "name": "delay_guest_mode_vid", "value": "3"}
    )
    driver.add_cookie(
        {"domain": ".www.tiktok.com", "name": "last_login_method", "value": "handle"}
    )
    driver.add_cookie(
        {"domain": ".www.tiktok.com", "name": "living_user_id", "value": "35638188158"}
    )
    driver.add_cookie(
        {
            "domain": ".tiktok.com",
            "name": "msToken",
            "value": "PM7BL1T5fRN8YnpwanwIBlVJFL1WIAepGIReqcuQABYDzy8j7VOGTY-R_V4VTzd03kHWtmTNHQeE41uCg7mNYjRVTGrsPGFvcAVQTHXwTqLZSYexMIBdqOiCRYNgpzNiJDCr_SvskzhKQt2EYrD9tJNIGQ==",
        }
    )
    driver.add_cookie(
        {
            "domain": ".tiktok.com",
            "name": "multi_sids",
            "value": "7405946633051522091%3A35d8c9f913f58ae06c1ea764253c519f",
        }
    )
    driver.add_cookie(
        {
            "domain": ".tiktok.com",
            "name": "odin_tt",
            "value": "88950a67260692785e7d5eb5b1349470d2f472bb7604a806b1299c9b5e41dd25ac4f74781f277431fe7070fd4759baa3c512e360ed972a79f9ee4d5e4c9e4046",
        }
    )
    driver.add_cookie(
        {
            ...
            "value": "da893805d2c6f97a65adf380ecbbb53d",
        }
    )
    driver.add_cookie(
        {
    ...
    driver.add_cookie(
        {
            ...
            "value": "{%22expireTimestamp%22:1729990800000%2C%22itemIds%22:[%227399467813406100778%22%2C%227407120547307392286%22]}",
        }
    )
    driver.add_cookie(
        {
            "domain": ".tiktok.com",
            "name": "s_v_web_id",
            "value": "verify_m2o5flgz_PMO4ZBI1_hMAd_4358_AX8B_V7aoe0tvVyGh",
        }
    )
    driver.add_cookie(
        {
    ...
    driver.add_cookie(
        {
            "domain": ".tiktok.com",
            "name": "tt_csrf_token",
            "value": "665Y6fiP-pqnD-ZIZP0i47D1PNDnf8NX6Qx4",
        }
    )
    driver.add_cookie(
        {
            "domain": ".tiktok.com",
            "name": "ttwid",
            "value": "1%7CSQooGgmwmkI4ZHjglAHKLX1i3shEoAf3PCMbXtIroHw%7C1729831831%7C295cdfcb29ce97bad010540dfecf6284d6eb68db7233b380cf82b104842f7eca",
        }
    )
    driver.add_cookie(
        {
            "domain": ".tiktok.com",
            "name": "uid_tt",
            "value": "e57d319f84a4cd7f01637c712ba56b8fb369863226f7f3b23cedd152d74164f1",
        }
    )
    driver.add_cookie(
        {
...
def comment(driver, element, type=1, text='lol'):
    element.click()

    comment_wrapper = WebDriverWait(driver, 300).until(
        EC.presence_of_element_located(
    ...
    if type == 1:
        ...
        WebDriverWait(driver, 300).until(
            EC.presence_of_element_located(
                (By.CSS_SELECTOR, "div.public-DraftEditorPlaceholder-inner")
            )
        )
        sleep(5)

        comment_input = comment_wrapper.find_element(
        ...
        # 回复评论
        comment_list = WebDriverWait(driver, 60).until(
        ...
        for comment_item in comment_list:
            p_elem = comment_item.find_element(By.XPATH, ".//p[@data-e2e='comment-level-1']")
            text = p_elem.find_element(By.TAG_NAME, 'span').text
            print(text)
            bol = is_have_keywords(text)
            if bol == True:
                reply_btn = comment_item.find_element(By.XPATH, ".//span[@data-e2e='comment-reply-1']")
                reply_btn.click()
                sleep(5)

                comment_sibling = comment_item.find_element(By.XPATH, "./following-sibling::*[1]")
                input_elem = WebDriverWait(comment_sibling, 60).until(
                    EC.presence_of_element_located(
                        (
                            By.XPATH,
    ...
    for result_item in search_results:
        ...
        if match:
            ...
            if any(item == video_id for item in ids_list) == False:
                ...
                comment(driver, result_item, type=2)
                break
