...
def login_with_cookie(driver):
    driver.get('https://www.tiktok.com/explore')
    driver.add_cookie({'name': 'uid_tt', 'value': 'e57d319f84a4cd7f01637c712ba56b8fb369863226f7f3b23cedd152d74164f1'})
    driver.add_cookie({'name': 'uid_tt_ss', 'value': 'e57d319f84a4cd7f01637c712ba56b8fb369863226f7f3b23cedd152d74164f1'})
